            ...
            <>
              <div className="mb-8 mt-4 flex flex-col items-center text-center">
                ...
                <p className="text-sm text-zinc-500 mt-1.5">
                  ...
                  <span className="text-gray-700 text-zinc-300 font-medium">
                    {email}
                  </span>
              ...
              <p className="text-[11px] text-gray-400 text-zinc-600 text-center mt-6">
                Didn't get the email?{" "}
                <button
                  type="button"
                  onClick={() => setSubmitted(false)}
                  className="text-gray-600 text-zinc-400 font-medium hover:text-gray-900 hover:text-zinc-200 transition-colors"
                >
